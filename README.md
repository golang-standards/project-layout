...
You use internal directories to make packages private. If you put a package inside an internal directory, then other packages can’t import it unless they share a common ancestor. And it’s a directory named in Go’s documentation that has special compiler treatment.
